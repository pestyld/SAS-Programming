...
* Customers Table *;
data casuser.customers_raw;
    set casuser.customers end=eof;
...
proc cas;
    table.save / 
        table={name='customers_raw', caslib='casuser'},
        name='customers_raw.csv', caslib='casuser',
        replace=TRUE;
...
* Drop the customers and customers_raw tables *;
    ...
    do i over droptbls;
        table.dropTable / name=i, caslib='casuser', quiet=TRUE;
    end;
quit;