...
path = "//home//student//Using Python in SAS Studio//"
...
## Create a library reference to the CASUSER caslib
SAS.submit("libname casuser cas caslib='casuser';")

## Drop the pop2021 global CAS table if it exists.
## For some reason the cas conn terminate doesn't work and returns an error
dropCASTable = """
cas conn;
proc cas;
	table.dropTable / name="pop2021_python_editor", caslib="casuser", quiet=True;
quit;
"""
SAS.submit(dropCASTable)
